...
describe('FAP - Test decoding GPGGA NMEA', function() {
    ...
    describe('#parseaprs - Test parsing a GPGGA packet with a bad checksum', function() {
        const parsed: AprsPacket = parser.parseAprs("DL5UY-3>GPSC70,DB0RO,WIDE1,F5ZEE,LX0APR-2,WIDE2*,qAR,DB0NIS-10:$GPGGA,222814.000,484768272,N,00829.8212,E,2,09,1.0,714.0,M,48.0,M,1.8,0000*7B");

...
describe('FAP - Status message decoding', function() {
    ...
    describe('#parseaprs - Status message\'s timestamp is not affected by the isRawTimestamp flag.', function() {
        ...
        const parsed: AprsPacket = parser.parseAprs(`KB3HVP-14>APU25N,WIDE2-2,qAR,LANSNG:>${timeStamp}${msg}`, parserOptions);
    ...
    describe('#parseaprs - Status message\'s timestamp is invalid.', function () {
        const parsed: AprsPacket = parser.parseAprs("KB3HVP-14>APU25N,WIDE2-2,qAR,LANSNG:>000000z>>Nashville,TN>>Toronto,ON", parserOptions);
    ...
    describe('#parseaprs - Status message has no timestamp', function() {
        const parsed: AprsPacket = parser.parseAprs("KB3HVP-14>APU25N,WIDE2-2,qAR,LANSNG:>Nashville,TN>>Toronto,ON", parserOptions);
    ...
    describe('#parseaprs - Status message has no body', function() {
        ...
        const parsed: AprsPacket = parser.parseAprs("KB3HVP-14>APU25N,WIDE2-2,qAR,LANSNG:>");
